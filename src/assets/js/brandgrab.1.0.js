document.addEventListener('DOMContentLoaded', function() {
	...
	var data = [
	    ...
	    {
	        logoSVG: '<svg width="222" height="222" viewBox="0 0 222 222" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M109.12 137.055H97.4259L100.484 117.648H112.538C115.117 117.648 117.261 118.038 118.97 118.816C120.679 119.595 121.894 120.733 122.613 122.23C123.333 123.728 123.513 125.555 123.153 127.711C122.703 130.766 121.279 133.087 118.88 134.674C116.511 136.261 113.258 137.055 109.12 137.055Z" fill="#C61800"/> <path d="M113.438 102.195H103.183L106.062 84.5859H116.676C119.735 84.5859 122.164 85.3346 123.963 86.832C125.792 88.3294 126.481 90.5156 126.032 93.3906C125.732 95.2474 124.997 96.8346 123.828 98.1523C122.658 99.4701 121.174 100.473 119.375 101.162C117.576 101.851 115.597 102.195 113.438 102.195Z" fill="#C61800"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M222 0H0V222H222V0ZM84.2924 65L69 157H112.358C119.015 157 124.952 155.877 130.17 153.631C135.387 151.385 139.63 148.3 142.898 144.377C146.167 140.454 148.221 135.977 149.06 130.945C149.78 126.633 149.45 122.859 148.071 119.625C146.691 116.361 144.532 113.815 141.594 111.988C138.655 110.132 135.207 109.143 131.249 109.023L131.429 108.125C135.087 107.406 138.4 106.104 141.369 104.217C144.367 102.3 146.841 99.9642 148.79 97.209C150.769 94.4238 152.059 91.3542 152.658 88C153.438 83.3281 152.883 79.2702 150.994 75.8262C149.135 72.3822 145.957 69.7168 141.459 67.8301C136.991 65.9434 131.249 65 124.233 65H84.2924Z" fill="#C61800"/> </svg>'
